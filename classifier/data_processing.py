...
def load_data(download=True):
    ...
    if download:
        data_path, _ = urlretrieve("http://archive.ics.uci.edu/ml/machine-learning-databases/car/car.data", "G:\Python35\workspace\\tmy\Machine_Learning\classifier\car.csv")
        print("Downloaded to car.csv")

    # use pandas to view the data structure
    col_names = ["buying", "maint", "doors", "persons", "lug_boot", "safety", "class"]
    data = pd.read_csv("G:\Python35\workspace\\tmy\Machine_Learning\classifier\car.csv", names=col_names)
    return data
